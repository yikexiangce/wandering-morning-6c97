...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ai-91
```

A live public deployment of this template is available at [https://ai-91.templates.workers.dev](https://ai-91.templates.workers.dev)
